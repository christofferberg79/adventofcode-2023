...
class Test {
    ...
    @Test
    fun day16() {
        assertEquals(46, Day16(Input("day16_ex1")).part1())
        assertEquals(6994, Day16(Input("day16")).part1())
        assertEquals(51, Day16(Input("day16_ex1")).part2())
        assertEquals(7488, Day16(Input("day16")).part2())
    }
...
//        assertEquals(0, Day17(Input("day17")).part2())         Out of Memory!
    ...
    @Test
    fun day18() {
        assertEquals(62, Day18(Input("day18_ex1")).part1())
        assertEquals(48795, Day18(Input("day18")).part1())
    ...
    @Test
    fun day19() {
        assertEquals(19114, Day19(Input("day19_ex1")).part1())
        assertEquals(373302, Day19(Input("day19")).part1())
    ...
    @Test
    fun day20() {
        assertEquals(32000000, Day20(Input("day20_ex1")).part1())
        assertEquals(11687500, Day20(Input("day20_ex2")).part1())
        assertEquals(879834312, Day20(Input("day20")).part1())
